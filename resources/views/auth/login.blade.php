...
<head>
    ...
    <title>Login | Tuffero_POS - Toko Kue Nastar & Brownies</title>
    ...
    <style>
        ...
        * {
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 3px rgba(140, 82, 28, 0.2);
        }
    ...
    <div class="login-container">
        <div class="banner-side">
            <div class="banner-content">
                ...
                <h1 class="banner-title">Selamat Datang</h1>
                <p class="banner-subtitle">Sistem Point of Sale untuk Toko Kue Nastar & Brownies Premium</p>
                ...
                <p class="quote">"Setiap gigitan nastar kami adalah kehangatan rumah yang dipanggang dengan cinta"</p>
            </div>
        </div>

        <div class="form-side">
            <!-- Alert untuk akun yang dinonaktifkan -->
            <div id="account-deactivated-alert" class="alert alert-danger" role="alert" style="display: none;">
            ...
            <form id="login" class="login-form" method="post" action="{{ url('/login') }}">
                @csrf
                <div class="input-group">
                    <i class="bi bi-person"></i>
                    <input id="email" type="email" class="form-control" name="email" placeholder="Email" required>
                    <div id="email-error" class="invalid-feedback" style="display: none;">Email tidak valid</div>
                </div>

                <div class="input-group">
                    <i class="bi bi-lock"></i>
                    <input id="password" type="password" class="form-control" placeholder="Password" name="password" required>
                    <div id="password-error" class="invalid-feedback" style="display: none;">Password tidak valid</div>
                </div>

                <button type="submit" class="btn btn-primary">
                    <span class="btn-text">Login</span>
                    <div id="spinner" class="spinner" role="status"></div>
                </button>
