...
-   run `git clone https://github.com/adamsafril19/tuffero_pos.git`
...
> **Important Note:** "Tuffero POS" uses Laravel Snappy Package for PDFs. If you are using Linux then no configuration is needed. But in other Operating Systems please refer to [Laravel Snappy Documentation](https://github.com/barryvdh/laravel-snappy).
...
-   run `docker build -t Tuffero-pos .`
